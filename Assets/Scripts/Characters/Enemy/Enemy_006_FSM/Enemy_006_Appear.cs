...
[SerializeField]
[CreateAssetMenu(menuName ="FSM/Enemy/Enemy_006/Appear",fileName = "Enemy_006_Appear")]
public class Enemy_006_Appear : EnemyState
{
    Vector3 movePos;
    Vector2 moveDir;
    float whitTime = 1f;
    ...
    public override void PhysicUpdate()
    {
        ...
        if(isCanMove)
        {
            ...
            {
                stateMachine.SwitchState(typeof(Enemy_006_Move));
            }
        }
    }
}
